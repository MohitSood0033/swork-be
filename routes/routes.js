...
const DeliveryAddress = require("../controllers/DeliveryAddress/deliveryAddress");

const enc_order = require("../common/order")
const handle_res = require("../common/order")
...
router.post("/shop-user-profilebyId", auth, shopUserData.getShopUserDatabyId);
...
router.post("/addServiceUserBank", auth, userData.addserviceUserBank);
...
router.post("/get-orderBydBId", Order.getOrderByDBId);

router.post("/get-orderauthById", auth, Order.getAuthOrderById);
...
router.post("/get-customerbyid", Customer.getCustomerbyid);
// routes for customer
router.post("/create-deliveryAddress",auth,DeliveryAddress.createCustomerDeliveryAddress );
router.post("/get-deliveryAddress", DeliveryAddress.getDeliveryAddressById);
router.post("/get-selectedDeliveryAddress", DeliveryAddress.getselectedDeliveryAddressById);
...
router.get("/encryptFormData",enc_order.encryptFormData)
router.post("/handleresponse",enc_order.handleresponse)
router.post("/handleSubscriptionResponse",enc_order.handleSubscriptionResponse)
